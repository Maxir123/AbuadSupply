...
export const createMainCategory = createAsyncThunk(
  ...
  async (categoryData, { rejectWithValue }) => {
    try {
      const { data } = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/categories`, categoryData, {
...
export const updateMainCategory = createAsyncThunk(
  ...
  async ({ categoryId, categoryData }, { rejectWithValue }) => {
    try {
      const { data } = await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/categories/${categoryId}`, categoryData, {
        headers: { 'Content-Type': 'application/json' },
      });
      return data.category;
    } catch (error) {
...
export const fetchSubcategories = createAsyncThunk(
  ...
  async (categorySlug, { rejectWithValue }) => {
    try {
      const { data } = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/subcategories?categorySlug=${categorySlug}`);
...
export const createSubcategory = createAsyncThunk(
  ...
  async (subcategoryData, { rejectWithValue }) => {
    try {
      const { data } = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/subcategories`, subcategoryData, {
        headers: { 'Content-Type': 'application/json' },
      });
...
export const updateSubcategory = createAsyncThunk(
  ...
  async ({ subcategoryId, subcategoryData }, { rejectWithValue }) => {
    try {
      const { data } = await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/subcategories/${subcategoryId}`, subcategoryData, {
        headers: { 'Content-Type': 'application/json' },
      });
      return data.subcategory;
    } catch (error) {
...
export const deleteSubcategory = createAsyncThunk(
  ...
  async (subcategoryId, { rejectWithValue }) => {
    try {
      await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/subcategories/${subcategoryId}`);
...
export const fetchSubSubcategories = createAsyncThunk(
  ...
  async (subCategorySlug, { rejectWithValue }) => {
    try {
      const { data } = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/sub-subcategories?subCategorySlug=${subCategorySlug}`);
...
export const createSubSubcategory = createAsyncThunk(
  ...
  async (subSubcategoryData, { rejectWithValue }) => {
    try {
      const { data } = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/sub-subcategories`, subSubcategoryData, {
        headers: { 'Content-Type': 'application/json' },
      });
...
export const updateSubSubcategory = createAsyncThunk(
  ...
  async ({ subSubcategoryId, subSubcategoryData }, { rejectWithValue }) => {
    try {
      const { data } = await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/sub-subcategories/${subSubcategoryId}`, subSubcategoryData, {
        headers: { 'Content-Type': 'application/json' },
      });
      return data.subSubcategory;
    } catch (error) {
...
export const deleteSubSubcategory = createAsyncThunk(
  ...
  async (subSubcategoryId, { rejectWithValue }) => {
    try {
      await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/sub-subcategories/${subSubcategoryId}`);
